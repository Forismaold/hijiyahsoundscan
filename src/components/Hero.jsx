            ...
            {/* <div className="flex items-center justify-center w-full  bg-neutral flex-1"> */}
                <div className="max-w-xl">
                    ...
                    <div className="flex flex-col mt-6 space-y-3 lg:space-y-0 lg:flex-row">
                        <p className="block px-5 py-2 text-sm font-medium tracking-wider text-center text-white transition-colors duration-300 transform bg-primary rounded-md hover:bg-gray-700">Mulai pindai</p>
                        <p className="block px-5 py-2 text-sm font-medium tracking-wider text-center text-neutral transition-colors duration-300 transform bg-base-100 rounded-md lg:mx-4 hover:bg-gray-300">Hijaiyah</p>
                    </div>
                </div>
            </div>
